          ...
          <ScrollReveal direction="right">
            ...
            <div className="max-w-[620px]">
              ...
              <p className="mt-12 text-[23px] leading-[1.8] text-white/70">
                ...
                From playback singers to independent voices —
                we map your listeners, your growth curve,
                and your next release with clarity.
              ...
              <div className="mt-16">
                ...
                <div className="space-y-5">
                  ...
                  <div className="flex gap-3 text-white/80">
                    ...
                    <span>Not knowing who is really listening</span>
                  ...
                  <div className="flex gap-3 text-white/80">
                    ...
                    <span>A career that plateaus after the first hit</span>
                  ...
                  <div className="flex gap-3 text-white/80">
                    ...
                    <span>A brief that never gets written down</span>
