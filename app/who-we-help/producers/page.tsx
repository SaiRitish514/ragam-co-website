...
>
  ...
  <h1 className="font-serif text-[60px] leading-[0.90] tracking-[-0.04em] text-white">
    ...
    Craft with the room in mind.

  </h1>

  <p className="mt-8 text-[23px] leading-[1.8] text-white/70">

    Sonic trend reports, reference libraries,
    and creative research for the studios
    shaping the region's new records.
  ...
  <div className="mt-8">
    ...
    <div className="space-y-5">
      ...
      <div className="flex gap-3 text-white/80">
        <span>•</span>
        <span>Chasing a sound that's already peaked</span>
      </div>

      <div className="flex gap-3 text-white/80">
        <span>•</span>
        <span>No shared reference library with artists</span>
      </div>

      <div className="flex gap-3 text-white/80">
        <span>•</span>
        <span>Undocumented craft</span>
      </div>
