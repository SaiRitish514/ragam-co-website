...
>
  ...
  <p className="mt-8 text-[23px] leading-[1.8] text-white/70">
    ...
    Concert briefs, curation strategy,
    and audience intelligence for the
    people staging Telugu music at scale.
  ...
  <div className="mt-8">
    ...
    <div className="space-y-5">
      ...
      <div className="flex gap-3 text-white/80">
        <span>•</span>
        <span>Booking without audience insight</span>
      </div>

      <div className="flex gap-3 text-white/80">
        <span>•</span>
        <span>Programming for the wrong city</span>
      </div>

      <div className="flex gap-3 text-white/80">
        <span>•</span>
        <span>Repeating last year's show</span>
      </div>
